...
interstellar = media.Movie(
    "Interstellar", "Humans search for an inhabitable planet",
    "https://upload.wikimedia.org/wikipedia/en/b/bc/Interstellar_film_poster.jpg",
    "https://www.youtube.com/watch?v=lRTTCrdzKAo",
    "Matthew McConaughey, Michael Caine")

skyfall = media.Movie(
    "Skyfall", "Ian Fleming's 007 Bond adventure",
    "http://www.impawards.com/2012/posters/skyfall.jpg",
    "www.youtube.com/watch?v=6kw1UVovByw", "Daniel Craig")

swingers = media.Movie(
...
braveheart = media.Movie(
    "Braveheart", "William Wallace fights for Scottish Independence",
    "https://upload.wikimedia.org/wikipedia/en/5/55/Braveheart_imp.jpg",
    "https://www.youtube.com/watch?v=wj0I8xVTV18", "Mel Gibson")

jaws = media.Movie(
    "Jaws", "A shark terrorizes a summer community",
...
# Add movie instances to movies array, used in open_movies_page method below
